...
public class ResponseProcessing {
    ...
    public static class SingleResponseProcessing{
        ...
        public List<Song> searchSingle(String stringJson) throws JSONException {
        ...
        public InputStream songPicStream(int id) throws IOException, JSONException {
            ...
            JSONObject jsonAl = jsonSong.getJSONObject("al");
            String stringUrl = jsonAl.getString("picUrl");
